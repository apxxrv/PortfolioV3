...
export function Hero() {
  return (
    <section id="home" className="px-4 py-16 sm:px-8 lg:px-12 lg:py-32">
      <div className="max-w-2xl">
        <motion.h1
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6, ease: [0.25, 0.46, 0.45, 0.94] }}
          className="text-3xl sm:text-4xl lg:text-5xl font-medium leading-tight tracking-tight text-foreground"
        >
          Apoorv Singh
        </motion.h1>
        ...
        <motion.p
          ...
          className="mt-6 text-sm lg:text-base text-muted-foreground leading-relaxed"
        >
        ...
        >
          <a
            ...
            className="inline-flex items-center px-4 py-2 text-sm bg-primary text-primary-foreground rounded-lg hover:opacity-90 transition-opacity duration-200"
          >
            Get in touch
          </a>
          <a
