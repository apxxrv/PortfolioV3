...
const statements = [
  ...
  "Systems that scale from zero to 250,000+.",
  "From healthcare to fashion — code that matters.",
  "Every LLM call is a conversation with intent.",
  "Ship fast. Think deep. Iterate always.",
]
...
export function About() {
  ...
  return (
    <section id="about" ref={containerRef} className="relative py-32 overflow-hidden md:py-0">
      ...
      <div className="relative flex items-center overflow-x-hidden py-4 gap-0 h-auto">
        <motion.div style={{ x: smoothX }} className="flex gap-16 md:gap-24 px-8 md:px-12 whitespace-nowrap">
          {statements.map((statement, index) => (
            <motion.p
              ...
              style={{
                WebkitTextStroke: index % 2 === 0 ? "none" : "1px var(--text-stroke)",
