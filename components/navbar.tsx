    ...
    <>
      ...
      >
        <nav className="flex items-center justify-between px-6 py-4 my-0 md:px-12 md:py-5">
          ...
          >
            <span className="font-mono text-xs tracking-widest text-muted-foreground">APOORV SINGH</span>
          ...
          {mounted && (
            <motion.button
              ...
              whileTap={{ scale: 0.9 }}
              className="hidden md:flex items-center justify-center w-8 h-8 text-muted-foreground hover:text-foreground transition-colors duration-300"
